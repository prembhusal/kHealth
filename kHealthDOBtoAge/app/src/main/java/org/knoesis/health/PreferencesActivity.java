...
import org.knoesis.health.SDPreferences;
...
public class PreferencesActivity extends KHealthAsthmaParentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Formatting
		prefLayout.setBackgroundColor(getResources().getColor(R.color.unit_preferences_color));
		...
		tempCelcius.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				prefEditor.commit(); // Preferences aren't updated until there is
									// a commit/apply.
			}
		});
